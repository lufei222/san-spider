 ...
 */
public class ICBCFinanceListPageSpider implements PageProcessor {
    private Logger log = LoggerFactory.getLogger(ICBCFinanceListPageSpider.class);
    // 定义连接失败时，重试机制
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new ICBCFinanceListPageSpider()).addUrl("https://mybank.icbc.com.cn/servlet/ICBCBaseReqServletNoSession?dse_operationName=per_FinanceCurProListP3NSOp&p3bank_error_backid=120103&pageFlag=0&menuLabel=10$17$TJ&Area_code=0200&requestChannel=302")
                .addPipeline(new ConsolePipeline())//pipline中保存数据，此例中consolepipeline直接将内容打印到控制台。可自己定义
                .addPipeline(new FilePipeline("D:\\webmagic\\icbc"))
                .run();
